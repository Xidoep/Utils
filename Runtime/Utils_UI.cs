...
namespace XS_Utils
{
    public static class XS_UI
    {
        ...
        public static Vector3 ToCanvas(this Vector3 position) => position.ToCanvas(MyCamera.Main);
        public static Vector3 ToCanvas(this Vector3 position, Camera camera) => camera.WorldToScreenPoint(position);
